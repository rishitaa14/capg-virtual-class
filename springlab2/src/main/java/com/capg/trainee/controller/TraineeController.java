...
public class TraineeController {
	...
	public ModelAndView addTrainee(@ModelAttribute Trainee trainee, Model m) {
	...
	public ModelAndView retriveAllTrainee() {
		return new ModelAndView("retrieveAllTrainee", "traineeList", service.retrieveAllTrainees());
